...
var Pathfinder = /** @class */ (function () {
    ...
    Pathfinder.prototype.searchPoolData = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var nextTokensToSearch, nextParentTokenAddresses, i, poolNode, t1Address, t2Address, parent_1, nextTokenAddress;
                        ...
                        switch (_a.label) {
                            ...
                            case 2:
                                ...
                                if (this.nodes[destinationAddress]) {
                                    path_1 = this.constructPath({ destination: this.userTokenOut });
                                    if (path_1) {
                                        this.allPaths.push(path_1);
                                    }
                                }
