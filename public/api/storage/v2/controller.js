...
exports.post = (0, errors_1.asyncErrorBoundary)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        pathData = null;
        pathsToOcean = JSON.parse(fs.readFileSync("api/data/chain".concat(chainId, "/pathsFromOcean.json")).toString());
        pathsFromOcean = JSON.parse(fs.readFileSync("api/data/chain".concat(chainId, "/pathsToOcean.json")).toString());
        oceanAddresses = JSON.parse(fs.readFileSync("api/data/oceanAddresses.json").toString());
